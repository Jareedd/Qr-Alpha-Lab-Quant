# Live paper-trading monitor — as of 2026-07-21

## Cycle continuity
- cycles logged: **27** (2026-06-10 → latest 2026-07-21)
- prediction logs: **26** of 27 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 26 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **25**; latest (2026-07-20 → cycle): 10,744 of 1,308,517 shared price cells changed (0.8211%), **258 return cells** changed (max |Δreturn| 7.89e-03)

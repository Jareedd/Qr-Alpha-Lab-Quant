# Live paper-trading monitor — as of 2026-07-23

## Cycle continuity
- cycles logged: **29** (2026-06-10 → latest 2026-07-23)
- prediction logs: **28** of 29 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 28 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **27**; latest (2026-07-22 → cycle): 4,306 of 1,309,786 shared price cells changed (0.3288%), **234 return cells** changed (max |Δreturn| 7.12e-03)

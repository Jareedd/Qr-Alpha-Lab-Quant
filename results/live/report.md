# Live paper-trading monitor — as of 2026-07-22

## Cycle continuity
- cycles logged: **28** (2026-06-10 → latest 2026-07-22)
- prediction logs: **27** of 28 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 27 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **26**; latest (2026-07-21 → cycle): 3,751 of 1,309,153 shared price cells changed (0.2865%), **254 return cells** changed (max |Δreturn| 3.58e-03)

# Live paper-trading monitor — as of 2026-07-27

## Cycle continuity
- cycles logged: **31** (2026-06-10 → latest 2026-07-27)
- prediction logs: **30** of 31 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 30 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **29**; latest (2026-07-24 → cycle): 13,816 of 1,311,016 shared price cells changed (1.0538%), **269 return cells** changed (max |Δreturn| 1.72e-02)

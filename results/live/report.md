# Live paper-trading monitor — as of 2026-07-20

## Cycle continuity
- cycles logged: **26** (2026-06-10 → latest 2026-07-20)
- prediction logs: **25** of 26 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 25 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **24**; latest (2026-07-17 → cycle): 10,743 of 1,307,877 shared price cells changed (0.8214%), **259 return cells** changed (max |Δreturn| 7.50e-03)

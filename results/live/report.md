# Live paper-trading monitor — as of 2026-07-14

## Cycle continuity
- cycles logged: **22** (2026-06-10 → latest 2026-07-14)
- prediction logs: **21** of 22 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 21 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **20**; latest (2026-07-13 → cycle): 2,157 of 1,305,337 shared price cells changed (0.1652%), **282 return cells** changed (max |Δreturn| 1.19e-02)

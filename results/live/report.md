# Live paper-trading monitor — as of 2026-06-13

## Cycle continuity
- cycles logged: **3** (2026-06-10 → latest 2026-06-12)
- prediction logs: **2** of 3 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
- weekdays in window with NO log: **0** — record is gap-free

## Live IC vs backtest IC
- measurable cycles: **0** of 2 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **1**; latest (2026-06-12 → cycle): 667,630 of 1,295,014 shared price cells changed (51.5539%), **785,005 return cells** changed (max |Δreturn| 1.02e+01)

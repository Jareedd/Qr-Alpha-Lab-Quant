# Live paper-trading monitor — as of 2026-07-31

## Cycle continuity
- cycles logged: **35** (2026-06-10 → latest 2026-07-31)
- prediction logs: **34** of 35 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 34 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **33**; latest (2026-07-30 → cycle): 6,473 of 1,317,230 shared price cells changed (0.4914%), **266 return cells** changed (max |Δreturn| 1.11e-02)

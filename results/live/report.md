# Live paper-trading monitor — as of 2026-07-09

## Cycle continuity
- cycles logged: **19** (2026-06-10 → latest 2026-07-09)
- prediction logs: **18** of 19 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 18 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **17**; latest (2026-07-08 → cycle): 6,426 of 1,300,717 shared price cells changed (0.4940%), **258 return cells** changed (max |Δreturn| 3.99e-03)

# Live paper-trading monitor — as of 2026-07-13

## Cycle continuity
- cycles logged: **21** (2026-06-10 → latest 2026-07-13)
- prediction logs: **20** of 21 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 20 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **19**; latest (2026-07-10 → cycle): 21,416 of 1,301,360 shared price cells changed (1.6457%), **260 return cells** changed (max |Δreturn| 1.75e-02)

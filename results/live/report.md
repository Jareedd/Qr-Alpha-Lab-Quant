# Live paper-trading monitor — as of 2026-07-07

## Cycle continuity
- cycles logged: **17** (2026-06-10 → latest 2026-07-07)
- prediction logs: **16** of 17 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 16 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **15**; latest (2026-07-06 → cycle): 36,799 of 1,299,451 shared price cells changed (2.8319%), **289 return cells** changed (max |Δreturn| 3.12e-01)

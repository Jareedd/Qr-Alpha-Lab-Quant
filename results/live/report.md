# Live paper-trading monitor — as of 2026-07-28

## Cycle continuity
- cycles logged: **32** (2026-06-10 → latest 2026-07-28)
- prediction logs: **31** of 32 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 31 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **30**; latest (2026-07-27 → cycle): 2,161 of 1,311,645 shared price cells changed (0.1648%), **284 return cells** changed (max |Δreturn| 2.90e-04)

# Live paper-trading monitor — as of 2026-07-08

## Cycle continuity
- cycles logged: **18** (2026-06-10 → latest 2026-07-08)
- prediction logs: **17** of 18 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 17 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **16**; latest (2026-07-07 → cycle): 53,016 of 1,300,084 shared price cells changed (4.0779%), **273 return cells** changed (max |Δreturn| 2.11e-02)

# Live paper-trading monitor — as of 2026-07-17

## Cycle continuity
- cycles logged: **25** (2026-06-10 → latest 2026-07-17)
- prediction logs: **24** of 25 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 24 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **23**; latest (2026-07-16 → cycle): 2,153 of 1,307,242 shared price cells changed (0.1647%), **267 return cells** changed (max |Δreturn| 1.62e-03)

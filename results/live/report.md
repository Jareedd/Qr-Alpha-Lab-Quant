# Live paper-trading monitor — as of 2026-07-10

## Cycle continuity
- cycles logged: **20** (2026-06-10 → latest 2026-07-10)
- prediction logs: **19** of 20 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 19 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **18**; latest (2026-07-09 → cycle): 142,191 of 1,300,724 shared price cells changed (10.9317%), **300 return cells** changed (max |Δreturn| 3.12e-01)

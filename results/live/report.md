# Live paper-trading monitor — as of 2026-07-06

## Cycle continuity
- cycles logged: **16** (2026-06-10 → latest 2026-07-06)
- prediction logs: **15** of 16 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 15 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **14**; latest (2026-07-03 → cycle): 69,584 of 1,298,819 shared price cells changed (5.3575%), **320 return cells** changed (max |Δreturn| 4.56e-02)

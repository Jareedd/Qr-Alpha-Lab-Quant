# Live paper-trading monitor — as of 2026-07-24

## Cycle continuity
- cycles logged: **30** (2026-06-10 → latest 2026-07-24)
- prediction logs: **29** of 30 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 29 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **28**; latest (2026-07-23 → cycle): 4,313 of 1,310,421 shared price cells changed (0.3291%), **257 return cells** changed (max |Δreturn| 6.12e-03)

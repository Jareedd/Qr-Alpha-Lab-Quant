# Live paper-trading monitor — as of 2026-08-03

## Cycle continuity
- cycles logged: **36** (2026-06-10 → latest 2026-08-03)
- prediction logs: **35** of 36 cycles (weights-only cycles predate prediction logging and cannot yield live IC)
...
- measurable cycles: **0** of 35 logged (a cycle matures 21 trading days after its as-of date)
...
- snapshot pairs compared: **34**; latest (2026-07-31 → cycle): 22,062 of 1,317,865 shared price cells changed (1.6741%), **318 return cells** changed (max |Δreturn| 1.19e-02)
